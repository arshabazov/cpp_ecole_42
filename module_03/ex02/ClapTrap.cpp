...
ClapTrap::ClapTrap(std::string name) : 
	...
	std::cout << "ClapTrap Contructor of " << name << " is called" << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap& clapTrap) {
	*this = clapTrap;
	std::cout	<< "ClapTrap Copy constructor of " << this->getName()
				<< " is called" << std::endl;
}

ClapTrap::~ClapTrap() {
	std::cout	<< "ClapTrap Destructor of " << this->getName()
				<< " called" << std::endl;
}
...
const ClapTrap& ClapTrap::operator = (const ClapTrap& other) {
	...
	std::cout	<< "Claptrap Assignment operator of " << this->getName()
				<< " is called" << std::endl;
...
void ClapTrap::takeDamage(unsigned int amount) {
	...
	std::cout	<< "CalpTrap " << this->getName() << " took damage of "
...
void ClapTrap::beRepaired(unsigned int amount) {
	...
	this->hitPoints += amount;
	std::cout	<< "CalpTrap " << this->getName() << " is perairing. "
